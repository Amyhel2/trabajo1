...
class Detailed_receivings extends Report
{
	...
	{
		return array(
			array('data'=>lang('common_item_id'), 'align'=>'left'),
			array('data'=>lang('reports_name'), 'align'=>'left'),
			array('data'=>lang('common_product_id'), 'align'=> 'left'),
			array('data'=>lang('common_serial_numbers'), 'align'=> 'left'),
			...
			array('data'=>lang('common_cost_price'), 'align'=>'left'),  
	...
	function get_report_details_recv($ids, $export_excel=0)
	{
		...
		foreach($res as $key=>$drow)
			{	
				...
				$details_data_row[] = array('data'=>to_quantity($drow['item_unit_price']), 'align'=> 'left');
