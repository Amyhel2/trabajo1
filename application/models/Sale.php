...
class Sale extends MY_Model
{
	...
	function get_sales_for_customer_by_items($item_id, $customer_id)
	{
		...
		$this->db->select('sales.sale_time, sales.sale_id, sales_items.item_unit_price, sales_items.discount_percent')
			->from('sales')
	...
	*/
	...
	public function get_detalle_venta_completo($sale_id)
	{
        ...
        sales_items.subtotal AS item_subtotal,

        items.name AS item_nombre
    ");
