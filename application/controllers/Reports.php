	...
	function generate($report)
	{
		...
		if (!empty($get)) {
			...
			if ($this->input->get('report_type') == 'simple') {
				...
				$dates = simple_date_range_to_date($report_date_range_simple, (bool)$this->input->get('with_time'), (bool)$this->input->get('end_date_end_of_day'));
			...
			if ($this->input->get('report_type_compare') == 'simple') {
				...
				$dates = simple_date_range_to_date($report_date_range_simple_compare, (bool)$this->input->get('compare_with_time'), (bool)$this->input->get('compare_end_date_end_of_day'));
