...
class Config extends Secure_area 
{
	...
	curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
      ...
      curl_close($ch);		
		...
		'validate_location_id_of_customer_when_adding_to_sale' => $this->input->post('validate_location_id_of_customer_when_adding_to_sale') ? 1 :0,
		'use_tier_price_for_price_check' => $this->input->post('use_tier_price_for_price_check'),
		'show_payments_on_work_order_sheet' => $this->input->post('show_payments_on_work_order_sheet') ? 1 : 0,
  ...
  public function generate_woo_oauth_url()
  {
    ...
    $params = array(
        'app_name' => $this->config->item('branding_name'),
