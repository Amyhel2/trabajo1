				...
				<table style="width: 100%;" id="receipt-table">
					...
					?>
						...
						if ($this->config->item('show_item_id_on_recv_receipt')) {
							...
							if($item->cart_line_supplier_id )
							{
								if ($item_number_for_supplier = $this->Additional_item_numbers->get_item_for_supplier($item->item_id, $item->cart_line_supplier_id))
								{
									$item_number_for_receipt = $item_number_for_supplier;
								}
							}
						}
