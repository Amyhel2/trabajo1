								...
								foreach (array_reverse($cart_items, true) as $line => $item) {
									...
									<tbody class="register-item-content" data-line="<?php echo $line; ?>">
										<tr class="register-item-details">
											...
											<?php
											if ($this->Employee->has_module_action_permission('sales', 'can_delete_item_from_sale', $this->Employee->get_logged_in_employee_info()->person_id) && (!$cart->suspended || $this->Employee->has_module_action_permission('sales', 'edit_suspended_sale_data', $this->Employee->get_logged_in_employee_info()->person_id))) {
											?>
	...
	<div class="register-box register-right">
		...
		<div class="sale-buttons">
			...
			<?php if (count($cart_items) > 0) { ?>
				...
				<?php if ($this->Employee->has_module_action_permission('sales', 'can_delete_item_from_sale', $this->Employee->get_logged_in_employee_info()->person_id) && (!$cart->suspended || $this->Employee->has_module_action_permission('sales', 'edit_suspended_sale_data', $this->Employee->get_logged_in_employee_info()->person_id))) { ?>
